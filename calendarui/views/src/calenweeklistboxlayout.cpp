...
// ---------------------------------------------------------------------------
// BC - Read layout data for week view
// ---------------------------------------------------------------------------
TInt TWeekListBoxLayout::LayoutVariantIndexBc(TWeekLayoutVariant aLayout) const
    {
    TInt layoutVariant(0);
    TRACE_ENTRY_POINT;
