...
void CCalenEventViewContainer::OnCmdFindPhoneNumL()
    ...
    SetToolbarVisibilityL(EFalse);
    finder->ExecuteLD();
    SetToolbarVisibilityL(ETrue);
...
// -----------------------------------------------------------------------------
// SetToolbarVisibilityL
// Shows or hides the toolbar.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
void CCalenEventViewContainer::SetToolbarVisibilityL(TBool aMakeVisible)
    {
    TRACE_ENTRY_POINT;
    MCalenToolbar* toolbar = iServices.ToolbarOrNull();
    if(toolbar)
        {
        toolbar->SetToolbarVisibilityL(aMakeVisible);
        }    
    TRACE_EXIT_POINT;
    }
