...
* Contributors:
*
* Description:   The file defines the debug macros.
*
*/
...
/** The clock debug flag */
#define __CLOCK_DEBUG__

// If the debug flag is not defined, all the macros are null.
#ifndef __CLOCK_DEBUG__
...
// Constants
#ifndef D_LOG_DIR
#define D_LOG_DIR _L("clock")			// The log directory.
#endif

#ifndef D_LOG_FILE
#define D_LOG_FILE _L("adtu.log")		// The log file.
#endif
...
#endif		// __CLOCK_DEBUG__

#endif		// __CLOCK_DEBUG_H__
