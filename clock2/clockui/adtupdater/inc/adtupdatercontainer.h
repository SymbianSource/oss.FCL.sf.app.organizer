	...
	private:		// New functions     
        ...
        */
         ...
         */
		 ...
		 /**
          * @brief  Define PS Key for installer note suppression and set it to ETrue
          * for disabling installer note. EFalse for enabling installer note.
          * @return void
          */
         void DefineAndSetInstallerKey(TBool aSupressNote);

         /**
          * @brief  Set installer note suppression P&S key
          * @param ETrue- Enable installer note. EFalse - Disable installer notes.
          * @return void
          */
         void SetInstallerNotificationsStatus(TBool aState);
