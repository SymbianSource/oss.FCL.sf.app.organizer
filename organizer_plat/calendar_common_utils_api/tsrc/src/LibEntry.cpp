...
EXPORT_C CScriptBase* LibEntryL( 
    ...
    if( 0 == stringLeft.Compare( _L( "ViewActionAgendaUtils" ) ) )
        {
        return ( CScriptBase* ) CCalendarCommonUtilsTest::NewL( aTestModuleIf );
        }
    else if( 0 == stringLeft.Compare( _L( "DateUtils" ) ) )
        {
        return ( CScriptBase* ) CCalendarDateUtilsTest::NewL( aTestModuleIf );
        }
    else if( 0 == stringLeft.Compare( _L("MultiCalUtils") ) )
        {
        return ( CScriptBase* ) CCalendarMultiCalUtilsTest::NewL( aTestModuleIf );
        }
