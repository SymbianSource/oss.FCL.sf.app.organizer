...
#ifndef ICALUILOGDEF_H
#define ICALUILOGDEF_H
...
//#define ICALUI_ENABLE_LOGGING
//#define ICALUI_ENABLE_MRDATA_LOGGING

// Defining this will direct all messages to a log file
#define ICALUI_LOG_TO_FILE

#endif // ICALUILOGDEF_H
